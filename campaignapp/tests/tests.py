...
def test_get_all_campaign():
    ...
    "result": {
        "0": {
            "name": "campaign 1",
            "start_time": "2023-01-05 00:00:00+00:00",
            "end_time": "2023-01-07 00:00:00+00:00",
            "budget": 10000,
            "bid_amount": 10,
        ...
        "2": {
            "name": "campaign 3",
            "start_time": "2017-09-29 00:00:00+00:00",
            "end_time": "2017-10-30 00:00:00+00:00",
            "budget": 10000,
            "bid_amount": 10,
            "title": "campaign title",
...
def test_get_campaign_by_user():
    response = requests.get(
        "http://127.0.0.1:8000/campaignapp/campaignbyuserid/2")
    print(response.json())
